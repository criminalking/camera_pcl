...
if("FALSE" STREQUAL "TRUE")
  set(openni_launch_SOURCE_PREFIX /home/criminalking/kinetic_workspace/sandbox/my_pcl_tutorial/openni/src/openni_launch)
  set(openni_launch_DEVEL_PREFIX /home/criminalking/kinetic_workspace/sandbox/my_pcl_tutorial/openni/devel)
  ...
  set(openni_launch_INSTALL_PREFIX /home/criminalking/kinetic_workspace/sandbox/my_pcl_tutorial/openni/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openni_launch' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/criminalking/kinetic_workspace/sandbox/my_pcl_tutorial/openni/install/${idir}'.  Ask the maintainer 'Isaac I.Y. Saito <130s@2000.jukuin.keio.ac.jp>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/criminalking/kinetic_workspace/sandbox/my_pcl_tutorial/openni/install/lib;/opt/ros/kinetic/lib)
